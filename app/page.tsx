     ...
     >
          ...
          <div className="z-10">
            ...
            <div className="space-y-4 text-black">
              <div className="flex items-center space-x-4">
                <Image src="/vscode.png" alt="vscode" width={24} height={24} />
                <span>Visual Studio Code</span>
              </div>
              <div className="flex items-center space-x-4">
                <Image src="/framer.png" alt="framer" width={24} height={24} />
                <span>Framer</span>
              </div>
              <div className="flex items-center space-x-4">
                <Image src="/whimsical.png" alt="whimsical" width={24} height={24} />
                <span>Whimsical</span>
              </div>
              <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                <Image src="/canva.png" alt="canva" width={24} height={24} />
                <span>Canva</span>
              </div>
              <div className="flex items-center space-x-4">
                <Image src="/maze.png" alt="maze" width={24} height={24} />
                <span>Maze</span>
              </div>
            </div>
          </div>
      ...
      <section id="showcase" className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex justify-center mb-8">
            <Image
              src="/linecash mockup.png"
              alt="LineCash Mobile Banking App"
              width={800}
              height={600}
              className="rounded-lg shadow-lg w-full max-w-4xl"
            />
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>Visual Hierarchy: Emphasized the key message &ldquo;Same Day Service&rdquo; along with three main benefits: Fast, Practical, and Maximum Results.</li>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <h4 className="text-xl font-bold text-black mt-8 mb-2">Creative Process:</h4>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>Copywriting: Used a conversational tone with a clear headline and tagline: &ldquo;We&apos;ll find the best place to you&rdquo; to build emotional connection and confidence.</li>
